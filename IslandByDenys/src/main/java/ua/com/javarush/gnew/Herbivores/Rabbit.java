...
public class Rabbit extends Animals {
    public Rabbit(int weight, int saturation, int speed) {
        super(weight, saturation, speed);
    }

    private static final ArrayList<Boar> rabbit = new ArrayList<>();
    private int x;
    private int y;

    public Rabbit(int weight, int speed, int saturation, int x, int y) {
        super(weight, saturation, speed);
        this.x = x;
        this.y = y;
    }
