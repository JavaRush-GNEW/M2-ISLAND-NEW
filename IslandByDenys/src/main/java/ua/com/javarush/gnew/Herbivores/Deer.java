...
public class Deer extends Animals {
    public Deer(int weight, int saturation, int speed) {
        super(weight, saturation, speed);
    }
    private static final ArrayList<Boar> deer = new ArrayList<>();
    private int x;
    private int y;

    public Deer(int weight, int speed, int saturation, int x, int y) {
        super(weight, saturation, speed);
        this.x = x;
        this.y = y;
    }
