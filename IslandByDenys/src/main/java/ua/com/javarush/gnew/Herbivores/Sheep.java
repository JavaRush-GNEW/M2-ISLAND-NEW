...
public class Sheep extends Animals {
    public Sheep(int weight, int saturation, int speed) {
        super(weight, saturation, speed);
    }

    private static final ArrayList<Boar> sheep = new ArrayList<>();
    private int x;
    private int y;

    public Sheep(int weight, int speed, int saturation, int x, int y) {
        super(weight, saturation, speed);
        this.x = x;
        this.y = y;
    }
