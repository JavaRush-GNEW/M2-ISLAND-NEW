...
public class Goose extends Animals {
    public Goose(int weight, int saturation, int speed) {
        super(weight, saturation, speed);
    }
    private static final ArrayList<Boar> goose = new ArrayList<>();
    private int x;
    private int y;

    public Goose(int weight, int speed, int saturation, int x, int y) {
        super(weight, saturation, speed);
        this.x = x;
        this.y = y;
    }
