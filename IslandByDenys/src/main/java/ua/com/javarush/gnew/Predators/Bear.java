...
public class Bear extends Animals {
    public Bear(int weight, int saturation, int speed) {
        super(weight, saturation, speed);
    }

    private static final ArrayList<Boar> bear = new ArrayList<>();
    private int x;
    private int y;

    public Bear(int weight, int speed, int saturation, int x, int y) {
        super(weight, saturation, speed);
        this.x = x;
        this.y = y;
    }
