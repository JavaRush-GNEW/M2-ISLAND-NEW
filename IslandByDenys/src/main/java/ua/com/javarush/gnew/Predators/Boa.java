...
public class Boa extends Animals {
    public Boa(int weight, int saturation, int speed) {
        super(weight, saturation, speed);
    }
    private static final ArrayList<Boar> boa = new ArrayList<>();
    private int x;
    private int y;

    public Boa(int weight, int speed, int saturation, int x, int y) {
        super(weight, saturation, speed);
        this.x = x;
        this.y = y;
    }
