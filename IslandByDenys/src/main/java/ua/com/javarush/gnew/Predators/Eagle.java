...
public class Eagle extends Animals {
    public Eagle(int weight, int saturation, int speed) {
        super(weight, saturation, speed);
    }

    private static final ArrayList<Boar> eagle = new ArrayList<>();
    private int x;
    private int y;

    public Eagle(int weight, int speed, int saturation, int x, int y) {
        super(weight, saturation, speed);
        this.x = x;
        this.y = y;
    }
