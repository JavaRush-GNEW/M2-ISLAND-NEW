...
public class Mouse extends Animals {
    public Mouse(int weight, int saturation, int speed) {
        super(weight, saturation, speed);
    }

    private static final ArrayList<Boar> mouse = new ArrayList<>();
    private int x;
    private int y;

    public Mouse(int weight, int speed, int saturation, int x, int y) {
        super(weight, saturation, speed);
        this.x = x;
        this.y = y;
    }
