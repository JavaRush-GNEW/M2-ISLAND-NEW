...
public class Fox extends Animals {
    public Fox(int weight, int saturation, int speed) {
        super(weight, saturation, speed);
    }

    private static final ArrayList<Boar> fox = new ArrayList<>();
    private int x;
    private int y;

    public Fox(int weight, int speed, int saturation, int x, int y) {
        super(weight, saturation, speed);
        this.x = x;
        this.y = y;
    }
